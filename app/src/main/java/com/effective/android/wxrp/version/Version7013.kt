...
/**
 * 微信 7.0.13 版本
 * created by yummylau on 2020/04/05
 */
class Version7013 : VersionInfo {

    companion object {

        const val VERSION = "7.0.13"
         ...
         * 红包“開”的窗口 id
         */
        const val ID_PACKET_DIALOG_OPEN = "com.tencent.mm:id/dbr"               // 聊天页面 - 红包对话框 - 开

        /**
         * 红包详情页 id
         */
        const val ID_PACKET_DETAIL_POST_USER = "com.tencent.mm:id/d8w"          // 红包详情页 - 发送者信息 - "xxxx的红包"
        const val ID_PACKET_DETAIL_POST_NUM = "com.tencent.mm:id/d7l"           // 红包详情页 - 红包金额


        /**
         * 聊天页面 id
         */
        const val ID_CHAT_PAGER_ITEM = "com.tencent.mm:id/ak6"                     // 聊天界面 - 聊天列表 - item
        const val ID_CHAT_PAGER_ITEM_AVATAR = "com.tencent.mm:id/ajr"              // 聊天页面 - 聊天列表 - item - 头像
        const val ID_CHAT_PAGER_ITEM_PACKET = "com.tencent.mm:id/ak4"             // 聊天页面 - 聊天列表 - 红包布局
        const val ID_CHAT_PAGER_ITEM_PACKET_MESSAGE = "com.tencent.mm:id/r3"     // 聊天页面 - 聊天列表 - 红包布局 - 祝福语 "恭喜发财" 等，用户自己编辑的
        const val ID_CHAT_PAGER_ITEM_PACKET_FLAG = "com.tencent.mm:id/r6"        // 聊天页面 - 聊天列表 - 红包布局 - 底部 "微信红包"
        const val ID_CHAT_PAGER_ITEM_PACKET_TIP = "com.tencent.mm:id/qv"         // 聊天页面 - 聊天列表 - 红包布局 - 红包状态 "已领取"
        const val ID_CHAT_PAGER_TITLE = "com.tencent.mm:id/g7_"                    // 聊天页面 - 聊天列表 - 个人聊天则是昵称，群聊天则是群昵称

        /**
         * 首页-微信tab 聊天会话 id
         */
        const val ID_HOME_CHAT_LIST_ITEM = "com.tencent.mm:id/b2p"                // 首页列表 - 聊天会话 - item id
        const val ID_HOME_CHAT_LIST_ITEM_MESSAGE = "com.tencent.mm:id/cw7"        // 微信列表 每一个item中的文本id
        const val ID_WID_CHAT_LIST_TITLE_TEXT = "com.tencent.mm:id/e0n"           // 微信列表 每一个item中的会话名字

        /**
         * 首页-我tab
         */
        const val ID_HOME_USER_PAGER_AVATAT = "com.tencent.mm:id/tg"                 // 我的页面，微信头像
        const val ID_HOME_USER_PAGER_NICK = "com.tencent.mm:id/e0g"                  // 我的页面，微信昵称
        const val ID_HOME_USER_PAGER_WEICHATNUM = "com.tencent.mm:id/gf9"            // 我的页面，微信号
